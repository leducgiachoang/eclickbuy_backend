...
class them extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'hinh_anh1'=> 'required|image',
            'hinh_anh2'=> 'required|image',
            'hinh_anh3'=> 'required|image',
    ...
    public function messages(){
        return[
            ...
            'hinh_anh1.required'=>'Vui lòng không được để trống !',
            'hinh_anh1.image'=> 'Vui lòng chọn định dạng ảnh',
            'hinh_anh2.required'=>'Vui lòng không được để trống !',
            'hinh_anh2.image'=> 'Vui lòng chọn định dạng ảnh',
            'hinh_anh3.required'=>'Vui lòng không được để trống !',
            'hinh_anh3.image'=> 'Vui lòng chọn định dạng ảnh',
